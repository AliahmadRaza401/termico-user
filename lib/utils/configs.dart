...
const APP_NAME = 'Tehnico';
const APP_NAME_TAG_LINE = 'On-Demand Home Services App';
var defaultPrimaryColor = Color(0xFFc5824b);
...
const PROVIDER_PACKAGE_NAME = 'md.tehnico.provider';
const IOS_LINK_FOR_PARTNER =
    "https://apps.apple.com/in/app/ineed-provider-app/id1596025324";

const IOS_LINK_FOR_USER =
    'https://apps.apple.com/us/app/ineed-service-user/id1591427211';
