...
Future<void> setAppConfigurations(AppConfigurationModel data) async {
  ...
  log('🔍 [AppConfig] Setting jobRequestStatus from API: ${data.jobRequestServiceStatus}');
  await appConfigurationStore.setJobRequestStatus(data.jobRequestServiceStatus.validate().getBoolInt());
  log('🔍 [AppConfig] jobRequestStatus set to: ${appConfigurationStore.jobRequestStatus}');
  ...
  if (data.roleAndPermission != null) {
    ...
    log('🔍 [AppConfig] Setting postJobList from API: ${data.roleAndPermission!.postJobList}');
    await rolesAndPermissionStore.setPostJobList(data.roleAndPermission!.postJobList.getBoolInt());
    log('🔍 [AppConfig] postJobList set to: ${rolesAndPermissionStore.postJobList}');
